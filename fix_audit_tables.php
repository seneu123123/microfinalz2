<?php
/**
 * Fix Audit Tables - Drop and Recreate
 */
...
echo "<h2>Fixing Audit Database Tables</h2>";
...
try {
    ...
    foreach ($tables_to_drop as $table) {
        echo "<p>Dropping table: $table...</p>";
        $sql = "DROP TABLE IF EXISTS $table";
        if ($conn->query($sql)) {
            echo "<p>✅ Table '$table' dropped</p>";
        } else {
            echo "<p>⚠️ Error dropping '$table': " . $conn->error . "</p>";
        }
    }
    ...
    $sample_inserts = [
        "INSERT INTO audit_schedules (audit_id, audit_title, audit_type, department, auditor, start_date, end_date, status, description) VALUES
        ...
        "INSERT INTO audit_checklists (checklist_id, checklist_name, audit_type, department, checklist_items, status, created_by) VALUES
    ...
    echo "<p><a href='admin/audit-schedule.html'>Test Audit Schedule</a> | <a href='admin/audit-checklist.html'>Test Audit Checklist</a></p>";
